        ...
        <div class="bg-light p-3 border-radius">
            <form action="/user?action=edit" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="id" class="form-control" id="inputUserId"
                           aria-describedby="emailHelp" value="${user.id}" required readonly = "readonly">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="country" class="form-control" id="inputUserCountry"
                           aria-describedby="emailHelp" value="${user.country}" required>
                </div>
