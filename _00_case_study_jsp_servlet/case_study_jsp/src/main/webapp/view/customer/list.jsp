            ...
            <table class="table table-hover table-responsive" id="table-customer" width="100%" style="width: 100%;">
                ...
                <c:forEach items="${customerList}" var="customer" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <a class="text-white" href="/customer?action=edit&id=${customer.id}">
                        ...
                        <td>
                            <button type="button" class="btn bg-frm-darkblue text-white" data-toggle="modal"
                                    data-target="#c${customer.id}">
                                Delete
                            </button>
                            <div class="modal fade" id="c${customer.id}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="text-white"
                                               href="/customer?action=delete&id=${customer.id}">
